...
from .views import home, register, login_view, logout_view, create_post, posts, edit_post, delete_post, post_detail, favourite_posts, add_comment, rate_post, AboutUsView, search_posts, feedback_view
